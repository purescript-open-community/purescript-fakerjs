module Fakerjs2.Locales.EsMx.Location.BuildingNumber (building_number) where
...
building_number =
  ( unsafeCoerce
    ...
    , (unsafeCoerce :: Array TypeSafePattern -> NonEmptyArray TypeSafePattern)
        [ PAtom (LitChar ' ') Once, PAtom AnyDigit (Exactly 3) ]
    , (unsafeCoerce :: Array TypeSafePattern -> NonEmptyArray TypeSafePattern)
        [ PAtom (LitChar ' ') Once, PAtom AnyDigit (Exactly 4) ]
    ]
