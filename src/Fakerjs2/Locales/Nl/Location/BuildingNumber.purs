module Fakerjs2.Locales.Nl.Location.BuildingNumber (building_number) where
...
building_number =
  ( unsafeCoerce
    ...
    , (unsafeCoerce :: Array TypeSafePattern -> NonEmptyArray TypeSafePattern)
        [ PAtom (LitChar ' ') Once, PAtom (LitChar 'I') Once, PAtom AnyDigit (Exactly 3) ]
    , (unsafeCoerce :: Array TypeSafePattern -> NonEmptyArray TypeSafePattern)
        [ PAtom (LitChar ' ') Once, PAtom (LitChar 'I') (Exactly 2), PAtom AnyDigit (Exactly 3) ]
    , (unsafeCoerce :: Array TypeSafePattern -> NonEmptyArray TypeSafePattern)
        [ PAtom (LitChar ' ') Once, PAtom (LitChar 'I') (Exactly 3), PAtom AnyDigit (Exactly 3) ]
    ]
