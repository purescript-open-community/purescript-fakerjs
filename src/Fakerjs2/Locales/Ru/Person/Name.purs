module Fakerjs2.Locales.Ru.Person.Name (name) where
...
name = (unsafeCoerce :: Array (Weighted String) -> NonEmptyArray (Weighted NonEmptyString))
  ...
  , { value: "{{person.firstName}} {{person.middleName}} {{person.lastName}}", weight: 1 }
  , { value: "{{person.lastName}} {{person.firstName}} {{person.middleName}}", weight: 1 }
  ]
